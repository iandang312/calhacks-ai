...
import com.example.showgraphs.voice.DeepgramVoiceAssistant
import java.util.Locale
import java.util.concurrent.atomic.AtomicInteger
import kotlin.math.hypot

class DaisyService : android.app.Service(), ConversationEngine.Callbacks, DeepgramVoiceAssistant.Listener {

    private lateinit var voiceAssistant: DeepgramVoiceAssistant
    ...
    override fun onCreate() {
        ...
        voiceAssistant = DeepgramVoiceAssistant(this, this)
